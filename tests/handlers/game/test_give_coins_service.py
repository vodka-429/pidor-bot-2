...
class TestClaimCoins:
    ...
    def test_claim_coins_success_regular_player(self, mock_db_session):
    ...
    def test_claim_coins_success_winner(self, mock_db_session):
    ...
    def test_claim_coins_different_games(self, mock_db_session):
    ...
    def test_claim_coins_different_days(self, mock_db_session):
