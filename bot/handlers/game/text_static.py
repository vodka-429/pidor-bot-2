...
Голосование продлится *24 часа*\. Победитель получит все пропущенные дни\!
...
MISSED_DAYS_INFO_LESS_10 = """📊 *Пропущенные дни в этом году:*
...
MISSED_DAYS_INFO_MORE_10 = """📊 *Пропущенные дни в этом году:*
...
FINAL_VOTING_ERROR_TOO_MANY = """❌ *Ошибка\!* Слишком много пропущенных дней \(*{count}*\)\! Финальное голосование доступно только при количестве пропущенных дней менее 10\."""
