...
PLAYER_REMOVE_SUCCESS = """✅ {username} удалён из игры\. История сохранена\."""
PLAYER_REMOVE_NOT_FOUND = """❌ Не нашёл такого игрока в игре\."""
PLAYER_REMOVE_NO_REPLY = """❌ Ответь на сообщение игрока или укажи @username\."""
